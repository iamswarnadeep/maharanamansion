  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        royal: "bg-gradient-royal text-royal-foreground hover:scale-105 shadow-luxury hover:shadow-gold",
        gold: "bg-gradient-gold text-foreground hover:scale-105 shadow-gold font-bold",
        premium: "bg-card border-2 border-gold text-foreground hover:bg-gold hover:text-foreground shadow-soft hover:shadow-gold",
        hero: "bg-gradient-hero text-royal-foreground hover:scale-105 shadow-luxury font-bold text-lg px-8 py-4"
      },
      size: {
